...
// <o STARTUP_WARMUP_MS> Delay after microphone streaming starts [ms]
// <i> Time to allow before entering the inference loop (pipeline settle).
// <i> Default: 2000
#define STARTUP_WARMUP_MS 2000
