 ...
 * based on the configuration in sl_ml_audio_feature_generation_config_si91x.h. It also
 ...
 * used for inference, configured in sl_ml_audio_feature_generation_config_si91x.h.
 *
 * ```
 ...
 *
 * @param[in] buffer
 *    Pointer to the audio buffer to use for feature generation.
 *
 * @param[in] n_frames
 ...
 *    sl_ml_audio_feature_generation_config_si91x.h.
 *
 * @return
 *    SL_STATUS_OK for success
 *    SL_STATUS_FAIL
...
/**
 * @brief Microphone callback function type for audio feature generation.
 *
 * @param arg      User-defined argument passed to the callback.
 * @param data     Pointer to the audio data buffer.
 * @param n_frames Number of audio frames in the buffer.
 */
typedef void (*sl_ml_audio_feature_generation_mic_callback_t)(void* arg, const int16_t* data, uint32_t n_frames);

/**
 * @brief Set the microphone callback for audio feature generation.
 *
 * @param callback Function pointer to the microphone callback.
...
/**
 * @brief External audio buffer for audio feature generation.
 */
